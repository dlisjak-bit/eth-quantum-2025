# Our final solution: a clever combinatorics videogame.

As seen in img1 and img3.png. Ran out of time, present more at presentation.

All the important files are in `SOLUTION_Q8` folder, but not very well structured.
...
2.  **Gate Execution Rules**:
    ...
    - **MS Gates**:
      - Must be applied when both participating ions are located at the _same_ `interaction` node.
